...
print('r1 =>\n', r1)
print('r1 nbytes:', r1.nbytes, '\n')

r2 = np.arange(45.)  # create array 
r2.shape = (3, 3, 5)
print('r2 datatype:', r2.dtype)
print('r2 =>\n', r2)
print('r2 nbytes:', r2.nbytes, '\n')

r3 = np.arange(45, dtype=np.int8)  # create array -- set datatype to short int
r3.shape = (3, 3, 5)
print('r3 datatype:', r3.dtype)
print('r3 =>\n', r3)
print('r3 nbytes:', r3.nbytes, '\n')
